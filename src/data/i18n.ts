...
export const I18N: Record<string, any> = {
    en: {
      ...
      faq: [
        ...
        ['Which video formats does Cliptag support?', 'Cliptag reads the common editing and camcorder formats: MP4, MOV, M4V, AVI, MKV, MTS/M2TS, WebM, MPEG, WMV, FLV and MXF. Standard H.264/H.265 (including 10-bit) works fine. Camera-RAW formats such as R3D, BRAW, ProRes RAW, ARRIRAW and DNG are not supported yet — export or transcode them to a standard format first. Bit depth does not affect recognition, and your original file is always copied unchanged. Clips Cliptag cannot read are simply skipped with a notice, never altered.'],
    ...
    de: {
      ...
      faq: [
        ...
        ['Welche Videoformate unterstützt Cliptag?', 'Cliptag liest die gängigen Schnitt- und Camcorder-Formate: MP4, MOV, M4V, AVI, MKV, MTS/M2TS, WebM, MPEG, WMV, FLV und MXF. Standard-H.264/H.265 (auch 10-bit) funktioniert problemlos. Kamera-RAW-Formate wie R3D, BRAW, ProRes RAW, ARRIRAW und DNG werden noch nicht unterstützt — exportiere bzw. wandle sie vorher in ein Standardformat um. Die Farbtiefe spielt für die Erkennung keine Rolle, und deine Originaldatei wird immer unverändert kopiert. Clips, die Cliptag nicht lesen kann, werden einfach mit einem Hinweis übersprungen, nie verändert.'],
    ...
    fr: {
      ...
      faq: [
        ...
        ['Quels formats vidéo Cliptag prend-il en charge ?', 'Cliptag lit les formats de montage et de caméscope courants : MP4, MOV, M4V, AVI, MKV, MTS/M2TS, WebM, MPEG, WMV, FLV et MXF. Le H.264/H.265 standard (y compris 10 bits) fonctionne sans problème. Les formats RAW caméra comme R3D, BRAW, ProRes RAW, ARRIRAW et DNG ne sont pas encore pris en charge — exportez-les ou convertissez-les d\'abord dans un format standard. La profondeur de couleur n\'affecte pas la reconnaissance, et votre fichier original est toujours copié tel quel. Les clips que Cliptag ne peut pas lire sont simplement ignorés avec un avis, jamais modifiés.'],
    ...
    es: {
      ...
      faq: [
        ...
        ['¿Qué formatos de vídeo admite Cliptag?', 'Cliptag lee los formatos de edición y videocámara habituales: MP4, MOV, M4V, AVI, MKV, MTS/M2TS, WebM, MPEG, WMV, FLV y MXF. El H.264/H.265 estándar (incluido 10 bits) funciona sin problemas. Los formatos RAW de cámara como R3D, BRAW, ProRes RAW, ARRIRAW y DNG aún no son compatibles — expórtalos o conviértelos antes a un formato estándar. La profundidad de color no afecta al reconocimiento, y tu archivo original siempre se copia sin cambios. Los clips que Cliptag no puede leer se omiten con un aviso, nunca se modifican.'],
    ...
    pt: {
      ...
      faq: [
        ...
        ['Que formatos de vídeo o Cliptag suporta?', 'O Cliptag lê os formatos de edição e de câmara comuns: MP4, MOV, M4V, AVI, MKV, MTS/M2TS, WebM, MPEG, WMV, FLV e MXF. O H.264/H.265 padrão (incluindo 10 bits) funciona sem problemas. Formatos RAW de câmara como R3D, BRAW, ProRes RAW, ARRIRAW e DNG ainda não são suportados — exporta ou converte-os antes para um formato padrão. A profundidade de cor não afeta o reconhecimento, e o teu ficheiro original é sempre copiado sem alterações. Clips que o Cliptag não consegue ler são ignorados com um aviso, nunca alterados.'],
    ...
    it: {
      ...
      faq: [
        ...
        ['Quali formati video supporta Cliptag?', 'Cliptag legge i formati di montaggio e videocamera più comuni: MP4, MOV, M4V, AVI, MKV, MTS/M2TS, WebM, MPEG, WMV, FLV e MXF. L\'H.264/H.265 standard (anche a 10 bit) funziona senza problemi. I formati RAW di camera come R3D, BRAW, ProRes RAW, ARRIRAW e DNG non sono ancora supportati — esportali o convertili prima in un formato standard. La profondità di colore non influisce sul riconoscimento e il tuo file originale viene sempre copiato invariato. I clip che Cliptag non riesce a leggere vengono semplicemente saltati con un avviso, mai modificati.'],
